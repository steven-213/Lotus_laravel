...
return [
    ...
    | usados por la clase validadora. Algunas de estas reglas tienen varias
    | versiones, como las reglas de tamaño. Siéntete libre de modificar
    | cualquiera de estos mensajes aquí.
    |
    */
    ...
    | usando la convención "attribute.rule". Esto te permite definir rápidamente
    | un mensaje personalizado para una regla específica de un atributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas se usan para reemplazar el marcador de posición :attribute
