...
<body>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTitle">Booking</h5>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h3 class="text-center mt-5">FullCalendar 6 + Bootstrap 5 Laravel</h3>
    ...
    <body>
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h3 class="text-center mt-5">Calendario de Citas</h3>
                    <div class="col-md-11 offset-1 mt-5 mb-5">
                        <div id="calendar"></div>
                    </div>
                </div>
